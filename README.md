# mapReduce
Projet Polytech de map reduce en python avec du multithreading.
...
* On créé une boucle <code>ligne 116</code> pour créer tous nos Threads avec pour attribut 'mapper'
...
* Les reducer parcourent la liste 'aftermap' en cherchant un mot bien précis pour réunir toutes les occurences de ce mot (déjà précompté par paquet).
